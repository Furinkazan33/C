...
#define FR_RC_READ_ERROR -2		/* read error on file */
#define FR_RC_TOO_LONG -1		/* when line_length > line_size */
#define FR_RC_NOT_FINISHED 1 	/* current line in buffer not finished */
#define FR_RC_EOB 2				/* end of current buffer (EOF not yet read) */
#define FR_RC_EOF 0				/* end of file */

/* This function must be called in a loop until FR_RC_EOF (end of file reached).
