...
/*
	...
	type :
		...
		2 : postfix
*/
void __btree_run(btree *btree, void (*func)(void *), int direction, int type) {
	if(btree == NULL) {
		return;
	}
...
void btree_run_lr_pre(btree *btree, void (*func)(void *)) {
	__btree_run(btree, func, 0, 0);
}

void btree_run_lr_inf(btree *btree, void (*func)(void *)) {
	__btree_run(btree, func, 0, 1);
}

void btree_run_lr_post(btree *btree, void (*func)(void *)) {
	__btree_run(btree, func, 0, 2);
}

void btree_run_rl_pre(btree *btree, void (*func)(void *)) {
	__btree_run(btree, func, -1, 0);
}

void btree_run_rl_inf(btree *btree, void (*func)(void *)) {
	__btree_run(btree, func, -1, 1);
}

void btree_run_rl_post(btree *btree, void (*func)(void *)) {
...
*/
void *__btree_find(btree *btree, int (*compare)(void *, void *), void *data, int direction, int type) {
	void *res;
...
void *btree_find_lr_pre(btree *btree, int (*compare)(void *, void *), void *data) {
	return __btree_find(btree, compare, data, 0, 0);
}

void *btree_find_lr_inf(btree *btree, int (*compare)(void *, void *), void *data) {
	return __btree_find(btree, compare, data, 0, 1);
}

void *btree_find_lr_post(btree *btree, int (*compare)(void *, void *), void *data) {
	return __btree_find(btree, compare, data, 0, 2);
}

void *btree_find_rl_pre(btree *btree, int (*compare)(void *, void *), void *data) {
	return __btree_find(btree, compare, data, -1, 0);
}

void *btree_find_rl_inf(btree *btree, int (*compare)(void *, void *), void *data) {
	return __btree_find(btree, compare, data, -1, 1);
}

void *btree_find_rl_post(btree *btree, int (*compare)(void *, void *), void *data) {
...
void btree_delete(btree *tree, void (*free_data)(void *)) {
	if(tree->left) {
		btree_delete(tree->left, free_data);
	}
	if(tree->right) {
		btree_delete(tree->right, free_data);
	}
	free_data(tree->data);
	free(tree);
}
