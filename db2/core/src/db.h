...
db_base *db_line_set_int(db_base *db, array *line, size_t c, const int value);
db_base *db_line_set_double(db_base *db, array *line, size_t c, const double value);
db_base *db_line_set_string(db_base *db, array *line, size_t c, const char *value);
...
db_base *db_line_set_byref(db_base *db, array *line, size_t c, int any_type, void *value, size_t alloc);
